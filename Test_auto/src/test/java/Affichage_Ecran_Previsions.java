...
public class Affichage_Ecran_Previsions {
	...
	public void testAffichageEcranPrevision() throws InterruptedException {
		...
		Page_Mecanisation pageMecanisation = pageReception.passerSurMecanisation();
		Thread.sleep(10000);
		...
		Page_Prevision pagePrevision = pageMecanisation.ecranPrevision();
		Thread.sleep(10000);
